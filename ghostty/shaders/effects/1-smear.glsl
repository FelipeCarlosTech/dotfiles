// 1-smear — motion blur líquido (estilo "blaze"): el cursor se estira al moverse
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec4 smear = SMEAR_COLOR;
    newColor = mix(newColor, smear, antialising(sdfTrail));
    newColor = mix(newColor, smear, antialising(sdfCurrentCursor));
