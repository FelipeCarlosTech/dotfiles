-- The lualine theme name comes from lua/config/theme.lua, GENERATED by
-- scripts/theme.sh. Switch it with `theme <name>`, not by editing this file.
...
return {
  ...
  -- Description: A blazing fast and easy to configure Neovim statusline plugin.
  {
    ...
    opts = {
      options = {
        theme = theme.lualine, -- Statusline theme, matched to the active colorscheme
